...
public class IdGenerator {
  ...
  //temp
  private HashMap<Integer, StudentAttributes[]> allData = new HashMap<Integer, StudentAttributes[]>();
  ...
  public HashMap<Integer, StudentAttributes[]> loadDb() throws Exception {
    Database responsesDB = new Database("C:\\Users\\noell\\desktop\\cs0320\\project-1-bm9hlloivgzrpufh-dd7bya-juqm1y8gaypknwgq\\data\\project-1\\integration.sqlite3");
...
//    System.out.println("studentCount "+ studentCount);
  ...
  public List<Integer> kRecStudents(int numberOfRecs, int targetID, HashMap<Integer, StudentAttributes[]> students){
  ...
  public void kStudentsTeam(String num_k, HashMap<Integer, StudentAttributes[]> students) throws IOException {
    File file = new File("C:\\Users\\noell\\desktop\\cs0320\\project-1-bm9hlloivgzrpufh-dd7bya-juqm1y8gaypknwgq\\data\\project-1\\teams.txt");
